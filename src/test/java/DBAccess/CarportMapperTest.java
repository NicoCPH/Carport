...
//    (4,'someone@nowhere.com','sesam','customer');
    ...
    public void testLogin01() throws LoginSampleException {
        // Can we log in
        User user = CarportMapper.login( "jens@somewhere.com", "jensen" );
    ...
    public void testLogin02() throws LoginSampleException {
        ...
        User user = CarportMapper.login( "jens@somewhere.com", "larsen" );
    }
    ...
    public void testCreateUser01() throws LoginSampleException {
        ...
        CarportMapper.createUser( original );
        User retrieved = CarportMapper.login( "king@kong.com", "uhahvorhemmeligt" );
